...
<html lang="en">
    <head>
        ...
        <style>
            .bg-login {
                background-image: url('<?= base_url("assets/img/background-pesantren.png") ?>');
    ...
    <body class="bg-login">
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-dark" style="font-weight: 900;" href="<?= base_url('')?>"> <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pendukung Keputusan Pemilihan Pondok Pesantren Tahfidz</a>
            </div>
        </nav>
